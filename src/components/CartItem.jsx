...
const navigate=useNavigate();
    ...
    return (
        <div className="px-4 rounded-sm py-1 my-1 w-full md:w-1/2 lg:w-1/3">
            <div className="flex shadow-sm bg-white gap-4 ">
                <div className="flex-none relative w-[6rem] h-[5rem] border my-2 rounded-sm ">
...
<h4 className="text-sm md:text-sm lg:text-lg font-medium">4678 <sup>frs</sup></h4>                
