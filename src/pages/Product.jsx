        ...
        <motion.div
            ...
            <div className="sticky top-0 min-h-[3rem] z-10 bg-white ">
                <div className="flex justify-between- py-1 pl-2 mb-4">
                    ...
                    <h1 className="flex-1 text-lg text-center font-medium capitalize">new product hair</h1>
            ...
            <div className="md:flex  mt-6 ">
                ...
                <div className="text md:w-[20rem] lg:w-[30rem] font-montserrat px-4">
                    ...
                    <h2 className="text-montserrat font-medium w-[400px] max-w-[calc(100%-2.5rem)] mx-auto mb-4 ">Select Quantity</h2>
                    <Select defaultValue={number} options={options} className="mb-4  w-[400px] max-w-[calc(100%-2.5rem)] mx-auto" />
            ...
            focus:outline-none w-[400px] max-w-[calc(100%-2.5rem)] mx-auto block
                    ...
                    <button type="button" class="text-white text-center bg-black mb-2
            focus:outline-none w-[400px] max-w-[calc(100%-2.5rem)] mx-auto block
             hover:bg-slate-900 hover:text-white  font-medium rounded-none text-sm px-3 py-2 ">View Cart</button>
